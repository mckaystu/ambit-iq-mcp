  ...
  return (
    <section className="space-y-4 rounded-2xl border border-slate-700/70 bg-slate-900/40 p-4 shadow-sm sm:p-5">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold tracking-tight text-slate-100">HCLSoftware — allocation snapshot</h2>
        <p className="text-xs text-slate-400">Resource utilization and capacity from HCLSoftware professional services data</p>
      </div>
